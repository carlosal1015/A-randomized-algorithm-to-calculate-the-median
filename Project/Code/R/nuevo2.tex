...
\author{Jesús Jáuregui Alvarado, \and Miller Silva Menejes, \and Erwin Talla Chumpitaz y Carlos Aznarán Laos}
...
Este algoritmo funciona dividiendo en la mitad recursivamente en una cantidad de elementos, cuando son pequeñas cantidades se procede a ordenarlos y agruparlos, de manera progresiva hasta su totalidad. Tiene complejidad $O(n\log 2n)$.
